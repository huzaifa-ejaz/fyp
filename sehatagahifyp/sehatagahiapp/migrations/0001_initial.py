# Generated by Django 3.0.8 on 2021-06-03 06:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('WorkEmail', models.EmailField(max_length=64, validators=[django.core.validators.RegexValidator(regex='@sehatagahi.com$')])),
            ],
        ),
        migrations.CreateModel(
            name='Item',
